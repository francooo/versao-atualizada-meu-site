      ...
      <div className="container mx-auto px-4 pt-28">
        <div className="max-w-2xl mx-auto bg-[#111111] rounded-2xl shadow-lg p-6 flex flex-col md:flex-row items-center gap-6 mb-10 border border-[#1A1A1A]">
          ...
          <div className="flex-1">
            <h3 className="font-syne text-xl font-bold text-[#FFD100] mb-1">Parceiro Certificado Olist ERP Tiny</h3>
            <p className="text-[#AAAAAA] mb-2">Sou implementador e consultor parceiro do Olist Tiny ERP, pronto para ajudar sua empresa a automatizar processos, integrar sistemas e crescer com tecnologia de ponta.</p>
            <a href="https://tiny.com.br/parceiros-comerciais/sobre?parceiro=AFECOMMERCE" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#FFD100] hover:bg-[#E6BC00] text-[#0A0A0A] font-semibold px-6 py-2 rounded-full transition-all duration-300 mt-2">Ver perfil de parceiro</a>
          </div>
        </div>
      </div>
      <ServiceTemplate
